...
- **[Atlas](https://northwind-cloud.vercel.app/docs/atlas/intro)** — versioned (`1.0.0` archived, current docs represent the next release)
- **[Beacon](https://northwind-cloud.vercel.app/docs/beacon/intro)** — versioned independently of Atlas
